...
The innerworks SDK is an npm package and can be found here: [Innerworks-Web-SDK.](https://www.npmjs.com/package/@innerworks-me/iw-auth-sdk)\
Run the following command in your termianl to install the latest version of the SDK:
```
